{
  wayland.windowManager.hyprland.settings = {
    ...
    bind = [
      ...
      "SUPER ALT, F11, exec, ~/.config/eww/scripts/volume mic vol-down"
      "SUPER ALT, F12, exec, ~/.config/eww/scripts/volume mic vol-up"
      "SUPER ALT, F7, exec, ~/.config/eww/scripts/volume mic mute"
